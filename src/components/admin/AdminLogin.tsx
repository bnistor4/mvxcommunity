  ...
  return (
    <div className="max-w-md mx-auto py-16">
      <div className="text-center mb-8">
        <div className="inline-block brutal-border bg-primary text-black font-bold px-6 py-3 mb-4 rotate-2">
      ...
      <div className="brutal-card p-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          {error && (
            <div className="brutal-border border-destructive bg-white p-4 mb-6">
